...
var incompleteTaskHolder=document.querySelector(".section-todo_list");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".section-completed_list");//completed-tasks
...
var taskCompleted=function(){
  ...
  var listItem=this.parentNode;
  var label=listItem.querySelector('.label');
  label.classList.toggle('label-completed');
